...
function SharingPage() {
  ...
  const subjects = {
    ...
    MCA: {
      ...
      3: [
        ...
        {
          code: "ENG551",
          title: "Technical Writing and Communications Skills",
        },
  ...
  return (
    <section className="sharing-hero d-flex align-items-center justify-content-center">
      <div className="container text-center text-white">
        <div className="row justify-content-center">
          <div className="col-lg-8 text-section">
            <h1 className="display-3 mb-4">Upload Question Papers</h1>
